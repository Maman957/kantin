<?php
// Memulai laporan menggunakan TCPDF
$pdf = new TCPDF();
$pdf->AddPage('L', 'mm', 'A4');
...
// Header Laporan
$pdf->SetFont('', 'B', 14);
$pdf->Cell(280, 10, "Laporan Penjualan dan Keuangan - Bulan " . $bulan_ini_indo . ' ' . $tahun_ini, 0, 1, 'C');
$pdf->SetFont('', '', 12);
$pdf->Ln(5);
...
foreach ($laporan as $item):
    ...
    $bulan = $nama_bulan[date('F', strtotime($tanggal))];
...
// Output PDF
$pdf->Output('Laporan_Keuangan_Penjualan.pdf', 'I');
