...
<body class="login">
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <form action="<?= base_url('proses_daftar') ?>" method="post">
                        <div class="intro-x mt-8">
                            <input type="text" class="intro-x login__input form-control py-3 px-4 block" required autocomplete="off" id="nama_pengguna" name="nama_pengguna" placeholder="Nama" required>
                            <input type="text" class="intro-x login__input form-control py-3 px-4 block mt-4" name="username" required autocomplete="off" placeholder="Username" required>
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <a href="<?= base_url() ?>" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Masuk</a>
                        </div>
                    </form>
        ...
        <?php if (@$_SESSION['gagal']) { ?>
            <script>
                swal("Data user sudah ada!", "<?php echo $_SESSION['gagal']; ?>", "warning");
            </script>
