                                ...
                                <div class="grid grid-cols-12 gap-x-5">
                                    <div class="col-span-12 2xl:col-span-4">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input class="form-check-input" type="radio" id="kategori" name="kategori" value="1">
                                            <label class="form-check-label" for="kategori">Makanan</label><br>
                                            <input class="form-check-input" type="radio" id="kategori" name="kategori" value="2">
                                    ...
                                    <div class="col-span-12 2xl:col-span-5">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <textarea id="update-profile-form-5" class="form-control" name="deskripsi" placeholder="Deskripsi produk" required></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="w-52 mx-auto xl:mr-0 xl:ml-5">
                                            <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                                <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                                    <input type="file" id="fileInput" style="display: none" accept="image/*" name="gambar" />
                                                    <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                                        <img id="image" class="rounded-md" src="<?= base_url() . 'assets/img/upload.png' ?> " alt="Click to upload image">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
