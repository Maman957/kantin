...
$route['transaksi'] = 'ProdukController/transaksi';
$route['hapus_foto/(:num)'] = 'ProdukController/hapusFoto/$1';
$route['hapus_keranjang/(:num)'] = 'ProdukController/hapusKeranjang/$1';
$route['hapus_produk_keranjang/(:num)'] = 'ProdukController/hapusProdukKeranjang/$1';
...
$route['terbayar'] = 'ProdukController/terbayar';
